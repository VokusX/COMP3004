...
"border-left-width: 1px;"));
        ...
        powerLevelLabel->setGeometry(QRect(60, 310, 181, 20));
...
"border-left-style: solid;\n"
"border-left-width: 1px;"));
        powerLevelLabel->setAlignment(Qt::AlignCenter);
...
"border-right-width: 1px;"));
        ...
        timer->setGeometry(QRect(70, 200, 161, 61));
        QFont font1;
        ...
        program_lbl = new QLabel(centralwidget);
        program_lbl->setObjectName(QString::fromUtf8("program_lbl"));
        program_lbl->setGeometry(QRect(60, 250, 181, 20));
        program_lbl->setAlignment(Qt::AlignCenter);
        program_freq = new QLabel(centralwidget);
        program_freq->setObjectName(QString::fromUtf8("program_freq"));
        program_freq->setGeometry(QRect(60, 270, 181, 20));
        program_freq->setAlignment(Qt::AlignCenter);
        program_wave = new QLabel(centralwidget);
        program_wave->setObjectName(QString::fromUtf8("program_wave"));
        program_wave->setGeometry(QRect(60, 290, 181, 20));
        program_wave->setAlignment(Qt::AlignCenter);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        program_lbl->setText(QCoreApplication::translate("MainWindow", "TextLabel", nullptr));
        program_freq->setText(QCoreApplication::translate("MainWindow", "TextLabel", nullptr));
        program_wave->setText(QCoreApplication::translate("MainWindow", "TextLabel", nullptr));
    } // retranslateUi
